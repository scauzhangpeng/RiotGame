...
import com.muugi.riot.news.presenter.ColumnListDetailPresenter;
...
public class ColumnListDetailActivity extends CommonActivity<ColumnListDetailContract.View, ColumnListDetailContract.Presenter>
    ...
    @BindView(R2.id.tv_columnlist_title)
    TextView mTvColumnlistTitle;
    @BindView(R2.id.tv_columnlist_author)
    TextView mTvColumnlistAuthor;
    @BindView(R2.id.tv_columnlist_desc)
    TextView mTvColumnlistDesc;
    @BindView(R2.id.tv_columnlist_book)
    TextView mTvColumnlistBook;
    @BindView(R2.id.column_list_detail_layout)
    ...
    @BindView(R2.id.rv_column_list_detail)
    ...
    private void initRecyclerView() {
        ...
        if (isVideo) {
            ...
            mRvColumnListDetail.addItemDecoration(new AverageSpaceItemDecoration((int) ScreenUtil.dp2px(this, 10), true));
