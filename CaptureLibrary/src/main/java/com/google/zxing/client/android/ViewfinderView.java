...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        cornorColor = resources.getColor(R.color.cornor);
        bondColor = resources.getColor(R.color.bond);
        scannerAlpha = 0;
...
//                + corWidth, frame.bottom + corWidth, paint);
    ...
    private void drawScanLight(Canvas canvas, Rect frame) {
        ...
        Bitmap bitmap = ((BitmapDrawable) getResources().getDrawable(R.drawable.camera_scan)).getBitmap();
        if (scanLineTop == 0 || scanLineTop + bitmap.getHeight() + SCAN_VELOCITY >= frame.bottom) {
...
//            SCAN_VELOCITY = (int) (SCAN_VELOCITY > 10 ? Math.ceil(SCAN_VELOCITY) : 10);
        ...
        Rect scanRect = new Rect(frame.left, scanLineTop, frame.right, scanLineTop + bitmap.getHeight());
