...
import com.muugi.riot.discovery.hero.adapter.GoodsDetailAdapter;
import com.muugi.riot.discovery.hero.adapter.GoodsDetailHeroAdapter;
...
public class GoodsDetailActivity extends SimpleTopBarActivity {
    ...
    @BindView(R2.id.iv_good_icon)
    ImageView mIvGoodIcon;
    @BindView(R2.id.tv_good_name)
    TextView mTvGoodName;
    @BindView(R2.id.tv_prop_list)
    TextView mTvPropList;
    @BindView(R2.id.tv_goods_map_list)
    TextView mTvGoodsMapList;
    @BindView(R2.id.tv_price)
    TextView mTvPrice;
    @BindView(R2.id.tv_coprice)
    TextView mTvCoprice;
    @BindView(R2.id.tv_saleprice)
    TextView mTvSaleprice;
    @BindView(R2.id.tv_good_desc)
    TextView mTvGoodDesc;

    @BindView(R2.id.rv_produce_need)
    RecyclerView mRvProduceNeed;
    @BindView(R2.id.ll_produce_need)
    LinearLayout mLlProduceNeed;
    @BindView(R2.id.rv_can_produce)
    RecyclerView mRvCanProduce;
    @BindView(R2.id.ll_can_produce)
    LinearLayout mLlCanProduce;
    @BindView(R2.id.rv_suit_hero)
    RecyclerView mRvSuitHero;
    @BindView(R2.id.ll_suit_hero)
